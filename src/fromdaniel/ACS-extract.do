...
quietly infix                  ///
  ...
  byte    nsubfam     98-98    ///
  byte    ncouples    99-99    ///
  byte    nmothers    100-100  ///
  byte    nfathers    101-101  ///
  byte    multgen     102-102  ///
  byte    multgend    103-104  ///
  byte    qcostele    105-105  ///
  byte    qcostfue    106-106  ///
  byte    qcostgas    107-107  ///
  byte    qcostwat    108-108  ///
  byte    qfoodstm    109-109  ///
  byte    qownersh    110-110  ///
  byte    qrent       111-111  ///
  byte    qrentgrs    112-112  ///
  byte    qvalueh     113-113  ///
  byte    qbedroom    114-114  ///
  byte    qhhincome   115-115  ///
  int     pernum      116-119  ///
  double  perwt       120-129  ///
  byte    famunit     130-131  ///
  byte    famsize     132-133  ///
  byte    subfam      134-134  ///
  byte    sftype      135-135  ///
  byte    sfrelate    136-136  ///
  byte    cbsubfam    137-137  ///
  byte    cbsftype    138-138  ///
  byte    cbsfrelate  139-139  ///
  byte    momloc      140-141  ///
  byte    momrule     142-143  ///
  byte    poploc      144-145  ///
  byte    poprule     146-147  ///
  byte    sploc       148-149  ///
  byte    sprule      150-151  ///
  byte    nchild      152-152  ///
  byte    nchlt5      153-153  ///
  ...
  int     bpl         182-184  ///
  long    bpld        185-189  ///
  byte    citizen     190-190  ///
  byte    racamind    191-191  ///
  byte    racasian    192-192  ///
  byte    racblk      193-193  ///
  byte    racpacis    194-194  ///
  byte    racwht      195-195  ///
  byte    racother    196-196  ///
  byte    empstat     197-197  ///
  byte    empstatd    198-199  ///
  byte    labforce    200-200  ///
  int     occ         201-204  ///
  int     ind         205-208  ///
  byte    classwkr    209-209  ///
  byte    classwkrd   210-211  ///
  byte    wkswork2    212-212  ///
  byte    uhrswork    213-214  ///
  long    inctot      215-221  ///
  long    ftotinc     222-228  ///
  long    incwage     229-234  ///
  long    incss       235-239  ///
  long    incwelfr    240-244  ///
  long    incinvst    245-250  ///
  long    incretir    251-256  ///
  long    incsupp     257-261  ///
  long    incother    262-266  ///
  long    incearn     267-273  ///
  byte    vetdisab    274-274  ///
  byte    diffrem     275-275  ///
  byte    diffphys    276-276  ///
  byte    diffmob     277-277  ///
  byte    diffcare    278-278  ///
  byte    diffsens    279-279  ///
  byte    diffeye     280-280  ///
  byte    diffhear    281-281  ///
  byte    vetstat     282-282  ///
  byte    vetstatd    283-284  ///
  long    pwpuma00    285-289  ///
  byte    tranwork    290-291  ///
  int     trantime    292-294  ///
  byte    qage        295-295  ///
  byte    qfertyr     296-296  ///
  byte    qrelate     297-297  ///
  byte    qsex        298-298  ///
  byte    qbpl        299-299  ///
  byte    qcitizen    300-300  ///
  byte    qhispan     301-301  ///
  byte    qrace       302-302  ///
  byte    qclasswk    303-303  ///
  byte    qempstat    304-304  ///
  byte    qind        305-305  ///
  byte    qocc        306-306  ///
  byte    quhrswor    307-307  ///
  byte    qwkswork    308-308  ///
  byte    qincearn    309-309  ///
  byte    qincbus     310-310  ///
  byte    qincinvs    311-311  ///
  byte    qincothe    312-312  ///
  byte    qincreti    313-313  ///
  byte    qincss      314-314  ///
  byte    qincsupp    315-315  ///
  byte    qinctot     316-316  ///
  byte    qftotinc    317-317  ///
  byte    qincwage    318-318  ///
  byte    qincwelf    319-319  ///
  byte    qdifsens    320-320  ///
  byte    qdifphys    321-321  ///
  byte    qdifrem     322-322  ///
  byte    qdifmob     323-323  ///
  byte    qdifcare    324-324  ///
  byte    qdifeye     325-325  ///
  byte    qdifhear    326-326  ///
  byte    qvetdisb    327-327  ///
  byte    qvetper     328-328  ///
  byte    qvetstat    329-329  ///
  byte    qtrantim    330-330  ///
  byte    qtranwor    331-331  ///
  using `"usa_00003.dat"'
...
label var costelec   `"Annual electricity cost"'
label var costgas    `"Annual gas cost"'
label var costwatr   `"Annual water cost"'
...
label var qcostele   `"Flag for Costelec"'
label var qcostfue   `"Flag for Costfuel"'
label var qcostgas   `"Flag for Costgas"'
label var qcostwat   `"Flag for Costwatr"'
...
label var cbsubfam   `"Subfamily number (original Census Bureau classification)"'
label var cbsftype   `"Subfamily type (original Census Bureau classification)"'
label var cbsfrelate `"Subfamily relationship (original Census Bureau classification)"'
...
label var poprule    `"Rule for linking father (new)"'
...
label var qdifsens   `"Flag for Diffsens"'
label var qdifphys   `"Flag for Diffphys"'
label var qdifrem    `"Flag for Diffrem"'
label var qdifmob    `"Flag for Diffmob"'
label var qdifcare   `"Flag for Diffcare"'
label var qdifeye    `"Data quality flag for DIFFEYE"'
label var qdifhear   `"Data quality flag for DIFFHEAR"'
label var qvetdisb   `"Data quality flag for VETDISAB"'
...
label define qcostele_lbl 0 `"Not allocated"'
label define qcostele_lbl 3 `"Allocated, direct"', add
label define qcostele_lbl 4 `"Allocated"', add
label define qcostele_lbl 5 `"Allocated, direct"', add
label define qcostele_lbl 9 `"Allocated, direct/indirect"', add
label values qcostele qcostele_lbl

label define qcostfue_lbl 0 `"Not allocated"'
label define qcostfue_lbl 3 `"Allocated, direct"', add
label define qcostfue_lbl 4 `"Allocated"', add
label define qcostfue_lbl 5 `"Allocated, indirect"', add
label define qcostfue_lbl 9 `"Allocated, direct/indirect"', add
label values qcostfue qcostfue_lbl

label define qcostgas_lbl 0 `"Not allocated"'
label define qcostgas_lbl 3 `"Allocated, direct"', add
label define qcostgas_lbl 4 `"Allocated"', add
label define qcostgas_lbl 5 `"Allocated, indirect"', add
label define qcostgas_lbl 9 `"Allocated, direct/indirect"', add
label values qcostgas qcostgas_lbl

label define qcostwat_lbl 0 `"Not allocated"'
label define qcostwat_lbl 3 `"Allocated, direct"', add
label define qcostwat_lbl 4 `"Allocated"', add
label define qcostwat_lbl 5 `"Allocated, indirect"', add
label define qcostwat_lbl 9 `"Allocated, direct/indirect"', add
label values qcostwat qcostwat_lbl
...
label define cbsubfam_lbl 0 `"Group quarters or not in subfamily"'
label define cbsubfam_lbl 1 `"1st subfamily in household"', add
label define cbsubfam_lbl 2 `"2nd subfamily in household"', add
label define cbsubfam_lbl 3 `"3rd"', add
label define cbsubfam_lbl 4 `"4th"', add
label define cbsubfam_lbl 5 `"5th"', add
label values cbsubfam cbsubfam_lbl

label define cbsftype_lbl 0 `"Group quarters or not in subfamily"'
label define cbsftype_lbl 1 `"Married-couple related subfamily with children"', add
label define cbsftype_lbl 2 `"Married-couple related subfamily without children"', add
label define cbsftype_lbl 3 `"Father-child related subfamily"', add
label define cbsftype_lbl 4 `"Mother-child related subfamily"', add
label values cbsftype cbsftype_lbl

label define cbsfrelate_lbl 0 `"Group quarters or not in subfamily"'
label define cbsfrelate_lbl 1 `"Reference person"', add
label define cbsfrelate_lbl 2 `"Spouse (married-couple subfamily only)"', add
label define cbsfrelate_lbl 3 `"Child"', add
label define cbsfrelate_lbl 8 `"1960s cases to be allocated"', add
label values cbsfrelate cbsfrelate_lbl
...
label define poprule_lbl 11 `"Direct link, clarity level 1"', add
label define poprule_lbl 12 `"Direct link, clarity level 2"', add
label define poprule_lbl 13 `"Direct link, clarity level 3"', add
label define poprule_lbl 14 `"Direct link, clarity level 4"', add
label define poprule_lbl 15 `"Direct link, clarity level 5"', add
label define poprule_lbl 16 `"Direct link, clarity level 6"', add
label define poprule_lbl 17 `"Direct link, clarity level 7"', add
label define poprule_lbl 18 `"Direct link, clarity level 8"', add
label define poprule_lbl 21 `"Second level link, clarity level 1"', add
label define poprule_lbl 22 `"Second level link, clarity level 2"', add
label define poprule_lbl 23 `"Second level link, clarity level 3"', add
label define poprule_lbl 24 `"Second level link, clarity level 4"', add
label define poprule_lbl 25 `"Second level link, clarity level 5"', add
label define poprule_lbl 26 `"Second level link, clarity level 6"', add
label define poprule_lbl 27 `"Second level link, clarity level 7"', add
label define poprule_lbl 28 `"Second level link, clarity level 8"', add
label define poprule_lbl 31 `"Third level link, clarity level 1"', add
label define poprule_lbl 32 `"Third level link, clarity level 2"', add
label define poprule_lbl 33 `"Third level link, clarity level 3"', add
label define poprule_lbl 34 `"Third level link, clarity level 4"', add
label define poprule_lbl 35 `"Third level link, clarity level 5"', add
label define poprule_lbl 36 `"Third level link, clarity level 6"', add
label define poprule_lbl 37 `"Third level link, clarity level 7"', add
label define poprule_lbl 38 `"Third level link, clarity level 8"', add
...
save "../ACS_2006_2017.dta", replace
